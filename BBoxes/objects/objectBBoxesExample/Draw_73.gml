...
if (device_mouse_check_button(0, mb_right) == true)
{
  for(var i = 0; i < mouse_x; i++)
  {
    var _mortonX = BBoxesZDecodeX(i);
    var _mortonY = BBoxesZDecodeY(i);
    var _mortonZ = BBoxesZEncode(_mortonX, _mortonY);
    var _w = 8;
    var _h = 8;
    var _x = 256 + _w * BBoxesZDecodeX(_mortonZ);
    var _y = 256 + _h * BBoxesZDecodeY(_mortonZ);
    draw_sprite_stretched(spriteBBoxes1x1, 1, _x, _y, _w, _h);
  }
}
